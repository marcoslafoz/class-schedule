...
export const Roulette: React.FC<RouletteProps> = props => {
  ...
  const calculateSpinBalance = React.useCallback((values: RouletteForm, prize: RouletteOption) => {
    ...
    switch (prize.prize) {
      case PRIZE_OPTIONS_ENUM.X1:
        win = (values.x1 || 0) * PRIZE_OPTIONS_ENUM.X1
        break
      case PRIZE_OPTIONS_ENUM.X3:
        win = (values.x3 || 0) * PRIZE_OPTIONS_ENUM.X3
        break
      case PRIZE_OPTIONS_ENUM.X5:
        win = (values.x5 || 0) * PRIZE_OPTIONS_ENUM.X5
        break
      case PRIZE_OPTIONS_ENUM.X10:
        win = (values.x10 || 0) * PRIZE_OPTIONS_ENUM.X10
        break
      case PRIZE_OPTIONS_ENUM.X20:
        win = (values.x20 || 0) * PRIZE_OPTIONS_ENUM.X20
        break
      default:
        win = 0
    }
