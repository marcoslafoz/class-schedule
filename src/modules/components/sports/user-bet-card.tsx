...
export const UserBetCard: React.FC<UserBetCardProps> = props => {
  ...
  return (
    <div className='flex flex-row  w-full justify-between text-center items-center px-3 py-2 gap-2 text-nowrap  border-1 border-white/10  text-white/25  rounded-full'>
